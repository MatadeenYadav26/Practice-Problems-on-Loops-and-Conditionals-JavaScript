...
// 1. allow only 3 attempts to enter correct password , if user gets it right early stop , if not -> "Account Locked"

// Pahla prompt -> 
// galat hua -> dusra prompt or corrrect -> stop
// 3rd prompt if galat -> Account locked
...
// let attempts = 0;
// let pass = "stop";
// let flag_Khulgaya = false;
// let password = prompt("Password Batao: ");
// if(password === pass) flag_Khulgaya = true;
// attempts++;
// while(password !== pass){
//     if (attempts === 3) {
...
// if (flag_Khulgaya === true){ console.log("Account Opened!")}
